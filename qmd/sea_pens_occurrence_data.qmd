...
Ces absences ne sont évidemment pas parfaites pour plusieurs raisons (e.g. problèmes d'identification, non-détection alors que l'espèce est bien présente), mais elles amènent sont tout de même utile lors de la modélisation des aires de distribution d'espèces [@loboUncertainNatureAbsences2010].
Nous avons donc inférer les absences pour les quatres espèces se situant dans l'estuaire et le golfe du Saint-Laurent:
